...
Le graphique ci-dessous montre le nombre d'instances de n-queens, $n \in {15,\dots,35}$, résolues en moins de 20 secondes par chacune des méthodes ci-dessus. Il est important de noter ici que l'on ne considère pas le temps, non-négligeable, nécessaire pour charger l'instance en mémoire.
...
%TODO : nombre d'instance résolue en fonction du temps %
